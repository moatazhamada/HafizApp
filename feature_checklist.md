...
- [x]  **Splash/Onboarding**:
    ...
    - [ ]  Fix white screen flash before splash. 
...
- [x]  **Localization**:
    ...
    - [ ]  App Guide page has non-localized English words. 
    - [x]  RTL layout support for Arabic.
- [x]  **Theme**:
    - [x]  Supports Light Mode, Dark Mode, and System Default.
    - [ ]  Fix inconsistent mode on first launch. 
...
- [ ]  **AppBar**:
    ...
    - [ ]  Localize search and use clearer naming. 
    ...
    - [x]  **Menu (Three dots)**:
        ...
        - [ ]  Enhance localization and correct attribution (Mohamed Sayed). 
- [x]  **Last Read Card**:
    ...
    - [ ]  "Continue Reading" button navigates to the exact scroll position in the Surah.
...
- [ ]  **Voice Verification**:
    ...
    - [ ]  **Dialog**:
        ...
        - [ ]  Enhance dialog localization.
        - [x]  Real-time feedback: Shows recognized text as you speak.
        - [x]  **Stop**: Manual stop or auto-silence detection (if implemented).
        - [ ]  Improve detection logic and feedback messaging.
    - [ ]  **Verification Logic**:
        - [x]  **Correct**: Green feedback → Auto-navigates to the **Next Verse**. 
        - [ ]  **Incorrect**: Red feedback → Shows "Wrong Recitation" dialog.
            - [ ]  **Try Again**: Re-opens mic dialog.
            - [ ]  **Save for Practice**: Adds verse to "Practice List" and moves to next verse.
            - [ ]  Fix "Try Again" and "Save for Practice" actions in Wrong Recitation dialog. 
...
- [ ]  **Navigation**:
    ...
    - [ ]  Search scroll-to and highlight not working. 
...
- [x]  **Bookmarks Screen**:
    ...
    - [ ]  Bookmark navigation scroll/highlight not working. 
...
- [x]  **Practice List (Recitation Errors)**:
    ...
    - [ ]  Practice list navigation scroll/highlight not working. 
...
- [x]  **About Screen**:
    ...
    - [ ]  Fix App Version not showing in About. 
