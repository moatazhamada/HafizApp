final Map<String, String> enUs = {
  ...
  'lbl_ayah': 'Ayah',
  'msg_verse_of': 'Verse {current} of {total}',
  ...
  // Bookmarks
  'msg_bookmark_added': 'Bookmarked',
  'msg_bookmark_removed': 'Removed',
  'msg_no_bookmarks': 'Start bookmarking verses',
  'msg_bookmarks_hint':
      'Save your reading progress and quickly return to important verses.',
  'lbl_verse_num': 'Ayah', // Unified to Ayah
  'lbl_remove_bookmark': 'Remove',
  'lbl_add_bookmark': 'Bookmark',
  'lbl_delete': 'Delete',
  ...
  'msg_incorrect_recitation': 'Keep practicing! You\'ll improve with time.',
  'lbl_tap_to_speak': 'Tap microphone to start',
  'msg_tap_to_stop': 'Tap to Stop',
  'lbl_search_tooltip': 'Search',
  // Offline
  ...
  'lbl_surahs': 'Surahs',
  'lbl_verses': 'Verses',
  'msg_no_results': 'No matches found',
  ...
  'msg_page_load_failed': 'Failed to load page {page}',
  ...
  'lbl_minutes': 'minutes',
  // Auto-scroll
  'lbl_autoscroll_settings': 'Auto Scroll Settings',
  'lbl_speed': 'Speed',
  'lbl_slow': 'Slow',
  'lbl_normal': 'Normal',
  'lbl_fast': 'Fast',
  ...
  'lbl_style_classic': 'Classic',
  'lbl_style_modern': 'Modern',
  'lbl_style_minimal': 'Minimal',
  'lbl_style_night': 'Night',
  'lbl_action': 'Action',
  ...
  'lbl_enable_auto_scroll': 'Enable Auto Scroll',
  'lbl_auto_scroll_enabled': 'Auto scroll is enabled',
  'lbl_auto_scroll_disabled': 'Auto scroll is disabled',
  ...
  'lbl_ramadan_start': 'Ramadan Start',
  'lbl_ramadan_end': 'Ramadan End',
  'lbl_eid_al_fitr': 'Eid Al-Fitr',
  'lbl_select_date': 'Select Date',
  'lbl_set_custom_dates': 'Set Custom Dates',
  'lbl_select_your_region': 'Select Your Region',
  'lbl_cancel': 'Cancel',
  'lbl_save': 'Save',
  'lbl_custom_speed': 'Custom Speed',
};
