final Map<String, String> arEg = {
  ...
  'about_source_qf_content_desc': 'التفسير والترجمات وبيانات دراسة الآيات',
  'about_source_qf_sync': 'مزامنة مؤسسة القرآن (OAuth2)',
  'about_source_qf_sync_desc': 'مزامنة المفضلة مع Quran.com',
  'about_source_quranhub': 'واجهة قراءات QuranHub',
  'about_source_quranhub_desc': 'بيانات القراءات والروايات',
  'about_source_qurani': 'Qurani.ai QRC',
  'about_source_qurani_desc': 'التحقق الصوتي من التلاوة والتدريب',
  'lbl_coming_soon': 'قريباً',
  'lbl_ayah': 'آية',
  ...
  'msg_local_whisper_tip': 'تعرف صوتي ذكي بدون إنترنت',
  'msg_local_whisper_desc':
      'يعمل بالكامل بدون إنترنت. أكثر دقة للعربية القرآنية من التعرف الصوتي العادي. أول استخدام ينزّل النموذج المختار.',
  'lbl_whisper_model': 'نموذج الذكاء',
  'lbl_model_tiny': 'صغير جدًا',
  'lbl_model_tiny_desc': 'الأسرع، أقل دقة. مناسب للتجربة.',
  'lbl_model_base': 'أساسي',
  'lbl_model_base_desc': 'أفضل توازن بين السرعة والدقة.',
  'lbl_model_small': 'صغير',
  'lbl_model_small_desc': 'الأكثر دقة، لكن أبطأ ويحتاج ذاكرة أكثر.',
  'lbl_model_recommended': 'مُوصى به',
  'lbl_model_tiny_size': '~75 م.ب',
  'lbl_model_base_size': '~142 م.ب',
  'lbl_model_small_size': '~466 م.ب',
  'lbl_downloading_model': 'جاري تنزيل النموذج',
  'msg_model_downloading': 'جاري التنزيل... لا تغلق التطبيق',
  'msg_model_download_failed':
      'فشل التنزيل. تحقق من اتصال الإنترنت وحاول مرة أخرى.',
  ...
  'lbl_version': 'الإصدار',
  'lbl_latest': 'الأحدث',
  'lbl_special_thanks': 'شكر خاص',
  'changelog_3_1_0_intro': 'شكر خاص لمستخدمنا ',
  'changelog_3_1_0_user': 'HASBUL HSB',
  'changelog_3_1_0_outro':
      ' على ملاحظاته الدقيقة حول سورة يس (آية 36:26)، والتي أدت إلى تحسين نص الرسم العثماني. جزاه الله خيراً.',
  'changelog_3_1_0_1':
      'ترحيل كامل إلى نص الرسم العثماني — مطابق للكتابة القياسية للمصحف.',
  'changelog_3_1_0_2': 'خط نوتو نسخ العربي الجديد لعرض دقيق للأحرف المرتفعة.',
  'changelog_3_1_0_3': 'تحسين ارتفاع السطر لمنع قطع الحركات والتشكيل.',
  'changelog_3_1_0_4':
      'شاشة دراسة الآية — استكشاف النص العربي والترجمة والتفسير معاً.',
  'changelog_3_1_0_5':
  ...
  'changelog_3_0_0_3': 'مشغل صوتي مع دعم القراء.',
  'changelog_3_0_0_4': 'عرض صفحات المصحف مع عرض الآيات.',
  'changelog_3_0_0_5': 'التحقق الصوتي لممارسة التلاوة.',
  ...
  // Memorization Help
  'memorization_help_title': 'كيف يعمل الحفظ',
  'memorization_help_desc':
      'تتبع حفظك للقرآن باستخدام التكرار المتباعد (SRS).\n\n'
      '• اضغط زر + لإضافة سورة للتتبع.\n'
      '• تظهر بطاقات المراجعة عند استحقاق السورة للمراجعة.\n'
      '• اضغط علامة الصح على البطاقة المستحقة لتسجيل جودة الحفظ.\n'
      '• استخدم القائمة على أي سورة متتبعة لتسجيل مراجعة يدوية.\n'
      '• الحفظ المثالي يزيد الفترة؛ الفشل يعيد ضبطها.\n'
      '• تُعتبر السورة "محفوظة" بعد 5 مراجعات ناجحة.\n\n'
      'الحالات:\n'
      '• محفوظة — حفظ قوي، فترات طويلة\n'
      '• قيد التقدم — في طور التعلم\n'
      '• يحتاج مراجعة — صعوبة، راجع قريباً',

  // Review Dialog
  'dlg_review_title': 'كيف كان حفظك؟',
  'btn_perfect': 'ممتاز',
  'btn_hesitant': 'متردد',
  'btn_difficult': 'صعب',
  'btn_hard': 'صعب جداً',
  'btn_failed': 'فاشل',
  'msg_review_logged': 'تم تسجيل المراجعة',
  'lbl_log_review': 'تسجيل مراجعة',

  // الحفظ (يوميات الحفظ)
  'lbl_my_hifz': 'حفظي',
  'hifz_help_title': 'كيف يعمل الحفظ',
  'hifz_help_desc':
      'تتبع حفظك للقرآن على شكل مقاطع (مجموعات آيات) باستخدام دورة مراجعة مستوحاة من طرق الحفظ التقليدية.\n\n'
      '• اضغط + لإضافة مقطع جديد تحفظه.\n'
      '• الدروس الجديدة تُراجع يومياً (السباق).\n'
      '• الدروس الحديثة تُراجع كل 2–3 أيام (السباق القديم).\n'
      '• المقاطع المتقنة تُراجع أسبوعياً (الدور).\n'
      '• المقاطع المتقنة تماماً تُراجع كل أسبوعين.\n'
      '• إذا واجهت صعوبة، يصبح المقطع ضعيفاً ويحتاج تمريناً يومياً.\n\n'
      'الحالات:\n'
      '• جديد — تحفظه حالياً، راجع يومياً\n'
      '• حديث — تثبيت، راجع كل 2–3 أيام\n'
      '• متقن — مستقر، راجع أسبوعياً\n'
      '• محفوظ — محفوظ تماماً، راجع كل أسبوعين\n'
      '• ضعيف — يحتاج تمريناً إضافياً',
  'lbl_due_today': 'مستحق اليوم',
  'lbl_due_tomorrow': 'مستحق غداً',
  'lbl_new_lessons': 'دروس جديدة',
  'lbl_recent_lessons': 'حديث',
  'lbl_solid': 'متقن',
  'lbl_mastered': 'محفوظ',
  'lbl_weak': 'ضعيف',
  'lbl_hifz_progress': 'تقدم الحفظ',
  'lbl_new': 'جديد',
  'lbl_overdue': 'متأخر',
  'lbl_hifz_empty_title': 'ابدأ رحلة حفظك',
  'lbl_hifz_empty_subtitle': 'أضف مجموعة آيات لتبدأ تتبع حفظك',
  'lbl_add_hifz_entry': 'إضافة مقطع',
  'lbl_select_surah': 'اختر السورة',
  'lbl_start_verse': 'آية البداية',
  'lbl_end_verse': 'آية النهاية',
  'lbl_optional_title': 'عنوان اختياري',
  'lbl_optional_title_hint': 'مثال: الصفحة 1',
  'lbl_review_history': 'سجل المراجعة',
  'msg_confirm_delete_hifz': 'حذف هذا المقطع؟',
  'btn_good': 'جيد',
  'btn_okay': 'مقبول',
  'btn_forgot': 'نسيت',
