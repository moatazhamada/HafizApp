        ...
        body: BlocProvider<HomeBloc>.value(
          ...
          child: BlocBuilder<HomeBloc, HomeState>(
            builder: (context, state) {
              // ⚡ Bolt Optimization: Replacing SingleChildScrollView + shrinkWrap: true
              // with CustomScrollView + SliverList.builder to preserve list virtualization
              // and prevent O(N) layout time for the entire surah list.
              return SizedBox(
